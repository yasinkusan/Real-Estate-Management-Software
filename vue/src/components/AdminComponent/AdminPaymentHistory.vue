<template>
  <div>
          ...
          <div class="panel">
            <div class="panel-heading">
              <div class="row">
                <div class="col col-sm-3 col-xs-12">
                  <h4 class="title">Payment <span>History</span></h4>
                </div>
            ...
            <div class="panel-body table-responsive">
              <table class="table">
                ...
                <tbody v-for="payment in payments" :key="payment.paymentId">
                  <tr>
                    <td>{{ payment.date }}</td>
                    <td>{{ payment.firstName }}</td>
                    <!-- <td>
                      {{ payment.address.addressLine }}
    ...
    <!-- <div v-for="payment in filteredProperties" v-bind:key="payment.paymentId">
      <div>{{ payment.firstName }}</div>
    </div> -->
  </div>
</template>
...
export default {
  ...
  //       return payment.userId == "2" ? true : false;
  //     });
  //   },
  // },
  created() {
    paymentService
      .retrievePaymentsByOwnerId(this.$store.state.user.id)
      .then((response) => {
